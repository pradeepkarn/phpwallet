  ...
  <div class="col-lg-9 col-md-12">
    <div class="row">
      <div class="col"  id="#sendMoney">
        ...
        <div class="card">
          <div class="header">
            <h2><strong>{{__('Strowallet Airtime')}}</strong></h2>
          </div>
          <div class="body">
            <div class="card">
              <div class="card-body">
                <div class="alert_message alert" style="display: none;"></div>
                  <form action="{{route('stroairtimeRequest',app()->getLocale())}}" method="POST" id="submit_form">
                    @csrf
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded',function(){
        $('body').on('click','#submit',function(event){
            ...
            var action="{{route('stroairtimeRequest',app()->getLocale())}}";
