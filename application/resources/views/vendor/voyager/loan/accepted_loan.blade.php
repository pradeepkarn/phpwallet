            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <table class="table table--light style--two">
                        ...
                        <tr>
                             <td>{{$key+1}}</td>
                            <td data-label="@lang('Username')">{{$data->user->firstname}}{{$data->user->lastname}}</td>
                            ...
                            <td>
                               <a href="{{route('loan.preview',[app()->getLocale(),$data->id])}}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i>View Detail</a>
                               @if(isset($data->status) && $data->status == 3)
                                    <a href="{{route('loan.payment_detail',[app()->getLocale(),$data->id])}}" class="btn btn-primary btn-xs">
                                        Payment Detail
                                    </a>
                               @endif
                            </td>
