                            ...
                            <ul class="member-actions">
                                    @if (Auth::check())
                                        <li><a href="{{ route('logout', app()->getLocale()) }}" class="login" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">{{ __('Logout') }} <form id="logout-form" action="{{ route('logout',  app()->getLocale()) }}" method="POST" style="display: none;">
                                        @csrf
                                    </form></a></li>
                ...
                <div class="col-md-7">
                    <div class="footer-links">
                        <ul class="footer-group">
                             @if (Auth::check())
                                <li> 
                                    <a href="{{url('/')}}/{{app()->getLocale()}}/home" >dashboard</a>
                                </li>
                            @else
                               <a href="{{url('/')}}/{{app()->getLocale()}}/login" >Get Started</a>
                            @endif
