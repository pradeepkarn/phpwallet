                        ...
                        <div class="row">
                            <div class="col">
                               <ul id="glbreadcrumbs-two">
                                    ...
                                    <li><a href="#" class="a"><strong>2.</strong> {{__('Add a money transfer method to your wallet')}}.</a></li>
                                    <li><a href="#" class="a"><strong>3.</strong> {{__('Finish your wallet creation')}}.</a></li>
                                </ul>
                            </div>            
        ...
        <div class="card">
            <div class="body text-center">
                <div class="chart easy-pie-chart-1" data-percent="67" style="margin-bottom:0px"> 
                    <span>
                        <img src="{{$currency->thumb}}" alt="user" class="rounded-circle">
                    </span> 
