                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li class="{{ (Route::is('my_tickets') ? 'active open' : '') }}"> 
                            <a href="{{ route('my_tickets',  app()->getLocale()) }}"><i class="icon-speedometer"></i><span>
                        ...
                        <li class="{{ (Route::is('mymerchants') ? 'active open' : '') }}"> 
                            <a href="{{route('mydeposits',  app()->getLocale())}}"><i class="icon-speedometer"></i><span>
                            {{__('My Deposits')}}</span></a>
                        </li>
                        <li class="{{ (Route::is('mymerchants') ? 'active open' : '') }}"> 
                            <a href="{{route('withdrawal.index',  app()->getLocale())}}"><i class="icon-speedometer"></i><span>
