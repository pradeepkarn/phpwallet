...
class User extends \TCG\Voyager\Models\User
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password','avatar', 'whatsapp', 'phonenumber', 'first_name', 'last_name', 'verified','role_id', 'settings', 'merchant', 'currency_id' ,'social', 'account_status', 'verification_token', 'balance', 'json_data',   'is_ticket_admin' , 'identity_verified','wallet_id', 'cs_token','cs_token_added_at'
    ];
