          ...
          <div class="body">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="card product_item ">
                                    <div class="body text-center" style="display: flex;align-items: center;justify-content: center; flex-direction: column;">
                                        <div class="cp_img">
                                            <img src="<?php echo e($transferMethod->thumbnail); ?>" alt="Product" class="img-fluid">
                                       
                                        </div>
                                        <h6 style="margin-top: 10px; "><?php echo e($transferMethod->name); ?><br><span class="text-success"> <?php echo e($transferMethod->pivot->adress); ?></span></h6>
            ...
            <form action="<?php echo e(route('post.withdrawal', app()->getLocale())); ?>" method="post" enctype="multipart/form-data" id="withdrawal_form">
              ...
              <input type="hidden" name="tmid" value="<?php echo e($transferMethod->id); ?>">
               <input type="hidden" name="pivx" value="<?php echo e($pivx); ?>">
              <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <div class="form-group <?php echo e($errors->has('fee') ? ' has-error' : ''); ?>">
                       <label for="fee">Net ( <small class=""> <?php echo e(__('amount')); ?> -  <?php echo e(__('Fees')); ?> &nbsp;</span></small> )</label>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <input type="submit" class="btn btn-primary " value="<?php echo e(__('Request Withdrawal')); ?>">
                </div>
              </div>
              <div class="clearfix"></div>
            </form>
