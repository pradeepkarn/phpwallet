  ...
  <div class="col-lg-9 col-md-12">
    <div class="row">
      <div class="col"  id="#sendMoney">
        ...
        <div class="card">
          <div class="header">
            <h2><strong><?php echo e(__('Strowallet Data')); ?></strong></h2>
          </div>
          <div class="body">
            <div class="card">
              <div class="card-body">
                <div class="alert_message alert" style="display: none;"></div>
                <form action="<?php echo e(route('buyStroDataRequest',app()->getLocale())); ?>" method="POST" id="submit_form">
                  <?php echo csrf_field(); ?>
                      ...
                      <div class="form-group">
                        <label>Choose Service</label>
                          <select class="form-control get_data_bundles" required="" name="service_id">
                              ...
                              <option data-url="<?php echo e(route('stro_get_data_bundles',[app()->getLocale(),'mtn-data'])); ?>" <?php echo (isset($service_id) && $service_id == 'mtn-data') ? 'selected':'mtn-data'; ?> value="mtn-data">
                                  MTN Data
                              </option>
                              <option data-url="<?php echo e(route('stro_get_data_bundles',[app()->getLocale(),'airtel-data'])); ?>" <?php echo (isset($service_id) && $service_id == 'airtel-data') ? 'selected':'mtn-data'; ?> value="airtel-data">
                                  Airtel Data
                              </option>
                              <option data-url="<?php echo e(route('stro_get_data_bundles',[app()->getLocale(),'glo-data'])); ?>" <?php echo (isset($service_id) && $service_id == 'glo-data') ? 'selected':'mtn-data'; ?> value="glo-data">
                                  GLO Data
                              </option>
                              <option data-url="<?php echo e(route('stro_get_data_bundles',[app()->getLocale(),'etisalat-data'])); ?>" <?php echo (isset($service_id) && $service_id == 'etisalat-data') ? 'selected':'mtn-data'; ?> value="etisalat-data">
                                  9mobile Data
                              </option>
                              <option data-url="<?php echo e(route('stro_get_data_bundles',[app()->getLocale(),'spectranet'])); ?>" <?php echo (isset($service_id) && $service_id == 'spectranet') ? 'selected':'spectranet'; ?> value="spectranet">
                                  Spectranet
                              </option>
                               <option data-url="<?php echo e(route('stro_get_data_bundles',[app()->getLocale(),'smile-direct'])); ?>" <?php echo (isset($service_id) && $service_id == 'smile-direct') ? 'selected':'smile-direct'; ?> value="smile-direct">
...
<div class="modal fade" id="addMyModalQr">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo e(route('buyStroDataRequest',app()->getLocale())); ?>" method="POST">
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded',function(){
        ...
        $('body').on('click','#submit',function(event){
            ...
            var action="<?php echo e(route('buyStroDataRequest',app()->getLocale())); ?>";
