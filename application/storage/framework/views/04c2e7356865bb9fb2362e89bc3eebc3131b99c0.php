                    ...
                    <div class="details col-lg-8 col-md-12" id="buy_form">
                        ...
                        <div class="card bg-light mt-5">
                            ...
                            <div class="body">
                                ...
                                <form accept-charset="UTF-8" action="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/buyvoucher/stripe" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="<?php echo e($_ENV['STRIPE_PUBLISHABLE_KEY']); ?>" id="payment-form" method="post">
