    ...
    <div class="row">
        ...
        <div class="col-md-9 ">
            ...
            <div class="body">
                ...
                <link href="//payzoft.com/css/materialize.css" type="text/css" rel="stylesheet">
<link href="//payzoft.com/css//style.css" type="text/css" rel="stylesheet">
<!-- Custome CSS-->
<link href="//payzoft.com/css/custom/custom.css" type="text/css" rel="stylesheet">
                        ...
                        <table class="table">
                            ...
                            <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('ticket_detail',[app()->getLocale(),$ticket->ticket_id])); ?>">
                                    ...
                                    <?php if($ticket->status != 'Closed'): ?>
                                        <td>
                                            <a href="<?php echo e(route('ticket_detail',[app()->getLocale(),$ticket->ticket_id])); ?>" class="btn btn-primary"><?php echo e(__('Comment')); ?></a>
                                        </td>
                                        <td>
                                            <form action="<?php echo e(route('close',[app()->getLocale(),$ticket->ticket_id])); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
