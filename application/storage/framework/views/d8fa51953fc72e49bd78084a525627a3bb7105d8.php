                            ...
                            <div class="body">
                                <?php if(session()->get('PurchaseRequest')->attempts > 1 and  session()->get('PurchaseRequest')->attempts <= 5 ): ?>
                                    ...
                                    <div class="alert alert-danger" role="alert" style="margin-top: 20px;">
                                        ...
                                        <strong>
                                            <a class="btn btn-link text-dark" href="<?php echo e(route('password.request', app()->getLocale())); ?>">
                                ...
                                <form class="form-horizontal" method="POST" action="<?php echo e(route('logandpay', app()->getLocale())); ?>">
                                ...
                                <div class="clearfix"></div>
                                <a href="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/register" class="btn btn-dark btn-block btn-lg" style="font-weight: bold; margin-bottom: 20px"><?php echo e(__('Create An Account')); ?></a>
                            </div>
                        </div>
                <?php if(
                                        ...
                                        <tbody>
                                            ...
                                            <?php if(setting('payment-gateways.enable_paypal') == 1): ?>
                                                <td style="border: 0" class="align-center">
                                                    <form method="post" action="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/merchant/storefront/paypal/<?php echo e($ref); ?>" id="paypal-form">
                                                        <input type="hidden" name="ref" value="<?php echo e($ref); ?>">   
                                                        <?php echo csrf_field(); ?>
                                            ...
                                            <?php if(setting('payment-gateways.enable_paystack') == 1): ?>
                                                <td style="border: 0"  class="align-center">
                                                    <form method="post" action="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/merchant/storefront/paystack/<?php echo e($ref); ?>" id="paystack-form">
                                                        <input type="hidden" name="ref" value="<?php echo e($ref); ?>">   
                                                        <?php echo csrf_field(); ?>
                                                        <a href="" onclick="event.preventDefault();
