                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li class="<?php echo e((Route::is('paymentlinks') ? 'active open' : '')); ?>"> 
                            ...
                            <?php echo e(__('Request Payment')); ?></span></a>
                        </li>
                        ...
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block"><i class="icon-bar-chart"></i><span><?php echo e(__('Exchange With Site Members')); ?></span></a>
                            <ul class="ml-menu">
