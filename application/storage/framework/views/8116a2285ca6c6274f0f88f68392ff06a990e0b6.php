            ...
            <div class="col-lg-5 col-md-12 offset-lg-1">
                <div class="card-plain">
                    ...
                    <form class="form" method="POST" action="<?php echo e(route('register', app()->getLocale())); ?>">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control <?php echo e($errors->has('first_name') ? ' is-invalid' : ''); ?>" name="first_name" value="<?php echo e(old('first_name')); ?>" placeholder="<?php echo e(__('Enter First Name')); ?>" required>
                            <span class="input-group-addon"><i class="zmdi zmdi-account-circle"></i></span>
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control <?php echo e($errors->has('last_name') ? ' is-invalid' : ''); ?>" name="last_name" value="<?php echo e(old('last_name')); ?>" placeholder="<?php echo e(__('Enter Last Name')); ?>" required>
                            <span class="input-group-addon"><i class="zmdi zmdi-account-circle"></i></span>
