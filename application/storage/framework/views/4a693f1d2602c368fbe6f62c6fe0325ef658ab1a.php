            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $pending_loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-label="<?php echo app('translator')->getFromJson('Action'); ?>">
                               <a href="<?php echo e(route('loan.preview',[app()->getLocale(),$data->id])); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i>View</a>
                            </td>
                        </tr>
                    ...
                    <?php if($pending_loans->LastPage() != 1): ?>
                      <div class="card-footer py-4">
                          <?php echo e($pending_loans->links()); ?>
