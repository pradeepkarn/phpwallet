                ...
                <div class="panel-body">
                    <table class="table table--light style--two">
                        ...
                        <tr>
                            ...
                            <th scope="col"><?php echo app('translator')->getFromJson('Action'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $approved_loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                             <td><?php echo e($key+1); ?></td>
                            <td data-label="<?php echo app('translator')->getFromJson('Username'); ?>"><?php echo e($data->user->firstname); ?><?php echo e($data->user->lastname); ?></td>
                            ...
                            <td data-label="<?php echo app('translator')->getFromJson('Action'); ?>">
                               <a href="<?php echo e(route('loan.preview',[app()->getLocale(),$data->id])); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i>View Detail</a>
                            </td>
                        </tr>
                    ...
                    <?php if($approved_loans->LastPage() != 1): ?>
                      <div class="card-footer py-4">
                          <?php echo e($approved_loans->links()); ?>
